...
const BASEURL = 'opendoc-family-justice-courts-practice-directions'.replace('/', '')
...
const S3_PDF_FOLDER = 'opendocsg/opendoc-family-justice-courts-practice-directions'.replace(/\//g, '-') + (IS_PROD ? '' : '-staging')
