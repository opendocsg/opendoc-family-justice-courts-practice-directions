(function () {
    ...
    var endpoint = null
    var env = 'production'
    var elasticSearchIndex = 'opendocsg-opendoc-family-justice-courts-practice-directions'
    ...
    function getLunrIndex() {
        return fetch('/opendoc-family-justice-courts-practice-directions/assets/lunrIndex.json')
            .then(function (res) {
                    return res.json()
            })
            .then(function (json) {
    ...
    var generateResultHTML = function (result, i) {
        ...
        searchTitle.innerHTML = result.documentTitle || "Family Justice Courts Practice Directions"
